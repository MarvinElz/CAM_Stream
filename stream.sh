...
# HD-Ready#                                                                                                                                                                                                      V -b 5000k             
# raspivid -o - -t 0 -vf -hf -fps 10 -w 1920 -h 1080 -b 3000000 -n | ffmpeg -re  -r 15 -ar 44100 -ac 2 -acodec pcm_s16le -f s16le  -ac 2 -i /dev/zero -f h264 -framerate 10  -i - -vcodec copy -acodec aac -ab 128k -strict experimental  -f flv rtmp://185.230.162.203/live/test
